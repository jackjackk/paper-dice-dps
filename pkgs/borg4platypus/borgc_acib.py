...
from borg import Direction, InitializationMode
...
class BorgC(Algorithm):
    ...
    def __init__(self, problem, epsilons, seed=None, do_postprocess=True, do_solve=True,
                 log_frequency=None, name=None, liveplot=False, pbar=True):
        """
        ...
        if name is not None:
            ...
            self.runtimedir = os.path.abspath(os.path.dirname(self.settings['runtimefile']))
